...
- Fixed the Justified paragraph alignment leaving most lines ragged. Since 1.7.0-yacp.3 the stretch of a justified
  line is capped at one natural space per gap (1.7.0-yacp.3 dropped the stretch entirely above that cap, 1.7.0 stable
  clamps it). At reader font sizes a line holds only a handful of gaps, so on an X3 at 14 pt most full lines exceed
  that budget and stop short of the right margin by up to a word width. Justified lines now again spread all
  remaining space across their gaps and reach the right margin; Left, Right and Center are unchanged. A book that
  was already indexed with Justified keeps its cached layout until it is re-indexed: change any layout setting
  (alignment, font, size, margin) once and switch it back.
...
- Offline dictionary lookup directly from an EPUB page: highlight a word and read its definition without leaving the
  ...
  and Cambridge/XDXF entries. A desktop preparation script and [setup guide](docs/dictionary.md) are included.
...
The seven English-language beta previews below illustrate the dictionary, reading refinements, and image settings.
The finished-book summary is an existing feature included in the beta gallery.

<table>
  <tr>
    <td align="center"><img src="docs/images/releases/1.7.0/reader-menu-main.png" alt="Dictionary in the reader menu" width="220"></td>
    <td align="center"><img src="docs/images/releases/1.7.0/dictionary-selector-final.png" alt="Select a word on the page" width="220"></td>
    <td align="center"><img src="docs/images/releases/1.7.0/dictionary-definition-final.png" alt="Read its definition offline" width="220"></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td align="center"><img src="docs/images/releases/1.7.0/reading-rhythm.png" alt="Clearer Reading Rhythm" width="264"></td>
    <td align="center"><img src="docs/images/releases/1.7.0/paragraph-justify.png" alt="Capped justification spacing" width="264"></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td align="center"><img src="docs/images/releases/1.7.0/01-image-rendering-options-x3-en.png" alt="Sleep-image rendering choices" width="264"></td>
    <td align="center"><img src="docs/images/releases/1.7.0/02-book-finished-realistic-x3-en.png" alt="Finished-book summary (existing feature)" width="264"></td>
  </tr>
  <tr>
